...
| [`row-2-8-overlap.md`](./row-2-8-overlap.md) | Companion analysis of the row 2 / row 8 overlap: two S≈50% design treatments only 4% apart in value, the dimming cascade behind rows 8–10, and the cool-side hue-band mechanism that lets some columns escape duplication |
